...
export const DeviceHardeningResultView = () => {
  ...
  const { hardeningResult, hardeningResultLoading } = useHardeningResultQuery();
    ...
    <div className="divide-y divide-gray-200 overflow-hidden rounded-2xl bg-white shadow-sm">
      ...
      <div className="p-6">
        <div className="flex gap-x-6">
          <div className="w-3/12 rounded-2xl bg-gray-100 p-4">
            <span className="text-sm font-bold text-gray-800">
              آمار نتایج بدست آمده
            </span>

            <div className="mt-2 space-y-2">
              <div className="flex rounded-lg bg-green-100 p-2 text-green-500">
              ...
              <div className="flex rounded-lg bg-red-100 p-2 text-red-500">
                <div className="flex items-center gap-x-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
              ...
              <div className="flex rounded-lg bg-gray-200 p-2 text-gray-500">
                <div className="flex items-center gap-x-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                ...
                <span className="mr-auto text-2xl font-bold">
                  {statistics.not_applicable_results_count}
                </span>
              </div>
            </div>
          </div>

          <div className="flex w-3/12 flex-col rounded-2xl bg-gray-100 p-4">
            <span className="text-sm font-bold text-gray-800">جزئیات هدف</span>

            <div className="mt-2 flex-1 space-y-4 rounded-lg bg-white p-4">
              <div className="flex justify-between text-sm">
                <span className="text-gray-500">هدف</span>
                <span className="font-bold text-gray-800">{device.ip}</span>
              </div>

              <div className="flex justify-between text-sm">
                <span className="text-gray-500">نسخه IOS</span>
                <span className="font-bold text-gray-800">
                  {hardeningResult.cis.version}
                </span>
              </div>

              <div className="flex justify-between gap-x-6 text-sm">
                <span className="shrink-0 text-gray-500">بررسی شده</span>
                <span dir="ltr" className="truncate font-bold text-gray-800">
                  {hardeningResult.cis.name}
                </span>
              </div>
            </div>
          </div>

          <div className="w-6/12 rounded-2xl bg-gray-100"></div>
        </div>

        <div className="space-y-4 mt-6">
          {Object.entries(hardeningResult.cis.categories).map(
            ([plane, categories]) => (
              <div key={plane}>
